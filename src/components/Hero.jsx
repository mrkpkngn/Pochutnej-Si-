...
import { Link } from "react-router-dom";
  ...
  const [header, setHeader] = useState(false);
    ...
    return (
        ...
        <Link to='/cateringu' className="bg-white p-3 md:p-4 md:text-lg text-orange text-sm rounded-md font-header flex flex-col text-center hover:text-white hover:bg-yellow hover:border-2" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="500" data-aos-anchor="#anchor">
          NABÍDKA CATERINGU <span className="text-xs md:text-sm font-body uppercase">Užijte si oslavu či večírek bez starostí!</span>
        </Link>
        <Link to='https://pochutnej-si.choiceqr.com/booking' className="bg-white p-3 md:p-4 md:text-lg text-orange text-sm rounded-md font-header flex flex-col text-center hover:text-white hover:bg-yellow hover:border-2" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="750" data-aos-anchor="#anchor">
          REZERVACE
        </Link>    
