...
import Heroimg from '../assets/img/Hero.png'
  ...
  const [header, setHeader] = useState(false);
    ...
    return (
        <div className="flex flex-col justify-center items-center mt-32 xs:mt-26  lg:mt-24 lg:h-[90vh] md:h-[100vh] sm:mt-24 xs:h-[90vh] h-[110vh] z-10 md:mt-44"> 
        ...
        <div className="flex flex-col gap-3 lg:hidden md:pb-32">
        ...
        <a href='' className="bg-white p-3 md:p-4 md:text-lg text-orange text-sm rounded-md font-header flex flex-col text-center hover:text-white hover:bg-yellow hover:border-4" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="250">
        ...
        <a href='' className="bg-white p-3 md:p-4 md:text-lg text-orange text-sm rounded-md font-header flex flex-col text-center hover:text-white hover:bg-yellow hover:border-4" data-aos="fade-right" data-aos-duration="1000">
          DÁRKOVÝ POUKAZ
        </a>          
      </div>
      </div>
