...
import "./hero.css"
  ...
  const [header, setHeader] = useState(false);
    ...
    return (
        ...
        <div className="block h-fit z-10"><img src={Heroimg} alt="Hero Image" className="pt-10 pb-10 md:w-[65rem] md:pt-[3rem] md:pb-[1rem] z-10"></img></div>
        ...
        <FaChevronDown className="hidden md:flex md:text-white md:text-3xl md:mt-12 md:animate-bounce"></FaChevronDown>
