    ...
    return (
        ...
        <div className='flex flex-col items-center gap-1 lg:items-end flex-1'>
          ...
          <div className='flex flex-row gap-2'>
            <a href='' className='p-1 bg-white rounded-md'><FaFacebookSquare className='text-orange lg:text-2xl' /></a>
            <a href='' className='p-1 bg-white rounded-md'><AiFillInstagram className='text-orange lg:text-2xl' /></a>
            <a href='' className='p-1 bg-white rounded-md'><FaSquarePhone className='text-orange lg:text-2xl' /></a>
          </div>
        </div>
      </div>
    )
